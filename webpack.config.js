...
module.exports = env => {
  ...
  return {
    ...
    resolve: {
      alias: {
        Templates: path.resolve(
          __dirname,
          "./Templates/Material-Pro"
        ),
        Orbital: path.resolve(__dirname, "./orbital"),
        Assets: path.resolve(
          __dirname,
          "./Templates/Material-Pro/_shared/material-kit-pro-react-v1.7.0/src/assets"
        ),
        Views: path.resolve(
          __dirname,
          "./Templates/Material-Pro/_shared/material-kit-pro-react-v1.7.0/src/views"
        ),
        Components: path.resolve(
          __dirname,
          "./Templates/Material-Pro/_shared/material-kit-pro-react-v1.7.0/src/components"
        ),
    ...
    devtool: env && env.production ? "" : "sourcemap"
  };
};
